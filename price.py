...
amdPrice = amd_element.text.split()[0]
amdPrice = math.floor(float(amdPrice) * 100) / 100
...
gelPrice = gel_element.text.split()[0]
gelPrice = math.floor(float(gelPrice) * 100) / 100
...
gbpPrice = gbp_element.text.split()[0]
gbpPrice = math.floor(float(gbpPrice) * 100) / 100
...
eurPrice = eur_element.text.split()[0]
eurPrice = math.floor(float(eurPrice) * 100) / 100
